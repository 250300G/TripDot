...
function CreateActivityPage() {
  ...
  const tripId = searchParams.get("tripId"); // On récupère l'ID du voyage depuis l'URL
  ...
  const handleSubmit = async (e) => {
    ...
    const newActivity = {
      tripId, // Très important pour lier l'activité au voyage !
      title,
      time,
      category,
    ...
    try {
      ...
      navigate(`/trips/${tripId}`); // Retour automatique au détail du voyage
    } catch (error) {
